...
{
    public partial class FR_aCFCancelarItemParcia_NFCe_Daruma : Form
    {
        public FR_aCFCancelarItemParcia_NFCe_Daruma()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                int iRetorno = 0;
                iRetorno = Declaracoes.aCFLancarAcrescimoItem_NFCe_Daruma(EDT_ITEM.Text, EDT_TipoAcresc, EDT_VALOR);
