...
$.extend($.validator, {
	...
	messages: {
	    ...
	    maxlength: $.validator.format("Por favor insira não mais do que  {0} characteres."),
	    minlength: $.validator.format("Por favor , insira pelo menos {0} characteres."),
	    rangelength: $.validator.format("Por favor insira um valor entre  {0} e {1} characteres."),
	    ...
	    min: $.validator.format("Por favor digite um valor superior ou igual a {0}.")
	},
